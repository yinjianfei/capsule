...
import { CapsuleComponent } from 'app/entities/capsule/capsule.component';
import { CapsuleService } from 'app/entities/capsule/capsule.service';
import { Capsule } from 'app/shared/model/capsule.model';

describe('Component Tests', () => {
    describe('Capsule Management Component', () => {
        let comp: CapsuleComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CapsuleComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.capsules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
