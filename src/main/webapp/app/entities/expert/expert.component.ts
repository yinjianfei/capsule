...
export class ExpertComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.expertService
            ...
            .subscribe(
                (res: HttpResponse<IExpert[]>) => this.paginateExperts(res.body, res.headers),
    ...
    trackId(index: number, item: IExpert) {
        return item.id;
    }
    ...
    protected paginateExperts(data: IExpert[], headers: HttpHeaders) {
